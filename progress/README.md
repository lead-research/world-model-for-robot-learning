...
# 当前活跃分类
active_category: "wm-for-rl"
# 已完成: Latent-space WM (6/6), Single-backbone (8/8), IDM-style (12/12), MoE/MoT (9/9), Unified VLA (12/12)
# 当前: World Model for RL（16篇，4/16完成）
```
...
- [ ] World4RL (arXiv'25.09) — **pending**
- [ ] VLA-RFT (arXiv'25.10) — **pending**
- [ ] ProphRL (arXiv'25.11) — **pending**
- [ ] WMPO (ICLR'26) — **pending**
- [ ] RehearseVLA (CVPR'26) — **pending**
- [ ] World-Gymnast (arXiv'26.02) — **pending**
- [ ] RISE (arXiv'26.02) — **pending**
- [ ] VLAW (arXiv'26.02) — **pending**
- [ ] GigaBrain-0.5M (arXiv'26.02) — **pending**
- [ ] WoVR (arXiv'26.02) — **pending**
- [ ] World-VLA-Loop (arXiv'26.02) — **pending**
- [ ] PlayWorld (arXiv'26.03) — **pending**
...
## 今日计划 (2026-05-30)
停滞8天后重启！今日完成 World Model for RL 前4篇：
- DayDreamer, UniSim, DiWA, World-Env

### 明日计划 (2026-05-31)
继续 World Model for RL（剩余12篇），目标4篇/日：
- World4RL, VLA-RFT, ProphRL, WMPO
...
| 2026-05-30 | notes/2026-05-30.md | 4 (DayDreamer, UniSim, DiWA, World-Env) |
